<div class="container-fluid">
	<div class="row">
		<div class="main-banner-home atracciones">
	...
	<div class="container p-top-40 p-bottom-40">
		<div class="row">
			<div class="atraccion-item col-xs-12 col-md-6 col-lg-4">
				...
				<div class="info">
					<h2 class="title mayus paytone">AQUA-RACER</h2>
					<p>110 metros de diversión acuática para competir con 3 amigos más, por el primer lugar. ¿Quién ganará?</p>
				</div>
			</div>
			...
			<div class="atraccion-item col-xs-12 col-md-6 col-lg-4">
				...
				<div class="info">
					<h2 class="title mayus paytone">AQUATUBOS</h2>
					<p>Toboganes que desembocan en alberca ¡Lánzate a la diversión!</p>
				</div>
			</div>
			...
			<div class="atraccion-item col-xs-12 col-md-6 col-lg-4">
				...
				<div class="info">
					<h2 class="title mayus paytone">KAMIKAZE</h2>
					<p>El de los amantes de la adrenalina, deslízate a toda velocidad desde gran altura. ¡Alucinante sensación!</p>
				</div>
			</div>
			...
			<div class="atraccion-item col-xs-12 col-md-6 col-lg-4">
				...
				<div class="info">
					<h2 class="title mayus paytone">TOBOGANES</h2>
					<p>Disfruta del paisaje mientras te deslizas 123 metros hacia una de nuestras albercas ¡Un básico de Los Camachos!</p>
				</div>
			</div>
			...
			<div class="atraccion-item col-xs-12 col-md-6 col-lg-4">
				...
				<div class="info">
					<h2 class="title mayus paytone">TORNADO</h2>
					<p>¡Sólo para valientes! disfruta de la velocidad del tobogán cerrado para luego caer a un embudo que te hará girar y girar</p>
				</div>
			</div>
			...
			<div class="atraccion-item col-xs-12 col-md-6 col-lg-4">
				...
				<div class="info">
					<h2 class="title mayus paytone">ZONA INFANTIL</h2>
					<p>Diversión garantizada para los más pequeños del hogar que se divierten en grande con resbaladizas y mini  toboganes.</p>
				</div>
			</div>
			...
			<div class="atraccion-item col-xs-12 col-md-6 col-lg-4">
				...
				<div class="info">
					<h2 class="title mayus paytone">MINI AQUA-RACER</h2>
					<p>Adrenalina para los más pequeños, la versión adecuada para niños de nuestro clásico Aqua-Racer.</p>
				</div>
			</div>
...
<div class="back-azul-00">
	<div class="container">
		...
		<div class="atracciones-map">
			<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/atracciones-mapa.png" alt="atracciones-mapa">
		</div>
